...
export const FilterPanel = ({
  ...
  return (
    <div className="relative">
      ...
      {isExpanded && (
        <div className="absolute top-full left-0 mt-2 w-[calc(100vw-2rem)] max-w-[500px] sm:max-w-[450px] md:max-w-[700px] bg-card border border-primary/20 rounded-xl shadow-md z-50">
          {hasActiveFilters && (
