  ...
  const RoundCheckbox = ({
    ...
    <div className="flex items-center">
      <div className="relative">
        ...
        />
        <div className="w-4 h-4 rounded-full border-2 border-primary peer-checked:border-primary peer-checked:bg-primary transition-colors flex items-center justify-center">
          {checked && (
      ...
      <label
        htmlFor={id}
        className="ml-2 text-sm font-medium text-foreground cursor-pointer hover:text-primary/80 transition-colors"
      >
        {label}
      </label>
    </div>
