...
export const GlobalResourceConfig = ({
  ...
  return (
    <div className="relative">
      <div
        className={`bg-card border border-primary/20 rounded-xl shadow-md transition-all duration-500 ease-in-out ${isOpen ? "absolute top-0 left-0 z-50 w-full min-w-[280px]" : "w-full max-w-[168px] sm:max-w-[192px] md:max-w-[216px] lg:max-w-[240px]"}`}
      >
        <button
