          ...
          >
            {onToggleCompare && (
              <button
                ...
                className={`w-14 sm:w-auto h-14 rounded-full flex items-center justify-center bg-card border-2 transition-all
            ...
            <button
              ...
              className="w-14 sm:w-auto h-14 rounded-full bg-card flex items-center justify-center border-2 border-border hover:border-primary/50 transition-all"
            >
