  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex items-center justify-between gap-3 mt-1">
        ...
        <Button
          size="sm"
          className="tracking-widest font-normal bg-[#FF931F] hover:bg-[#E6831A] text-white text-xs  px-3 py-1.5 rounded-full flex items-center justify-center gap-1 h-8 group"
