      ...
      {searchQuery && filteredProviders.length === 0 ? (
        ...
        <>
          ...
          {filteredProviders.length > providersToShow && (
            <div className="flex flex-col sm:flex-row justify-center items-center gap-[50px] sm:gap-[50px] mt-8">
              {/* Кнопка "Показать ещё 9 провайдеров" */}
              <button
                onClick={() => setProvidersToShow((prev) => prev + 9)}
                className="group relative px-6 py-3 bg-gradient-to-r from-primary to-primary/80 text-background font-bold text-base rounded-xl shadow-xl shadow-primary/30 hover:shadow-2xl hover:shadow-primary/40 transition-all hover:scale-[1.02] active:scale-[0.98] w-full sm:w-auto"
              >
              ...
              <button
                ...
                className="group relative px-6 py-3 bg-gradient-to-r from-secondary to-secondary/80 text-background font-bold text-base rounded-xl shadow-xl shadow-secondary/30 hover:shadow-2xl hover:shadow-secondary/40 transition-all hover:scale-[1.02] active:scale-[0.98] w-full sm:w-auto"
              >
