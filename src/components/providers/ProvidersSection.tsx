                ...
                <div className="flex flex-col sm:flex-row justify-center items-center gap-1 mt-4">
                  {sortedProviders.length > providersToShow && (
                    <button
                      ...
                      className="group relative px-6 py-3 bg-gradient-to-r from-primary to-primary/80 text-background font-normal text-base rounded-xl shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 transition-all hover:scale-[1.02] active:scale-[0.98] w-full sm:w-auto"
                    >
