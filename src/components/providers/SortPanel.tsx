  ...
  return (
    <div className="flex-none">
      <div className="px-2 py-1.5 sm:px-2.5 sm:py-2">
        <div className="inline-flex bg-muted/50 rounded-xl p-0.5 border border-primary/20 h-9 sm:h-10 relative">
          ...
          <button
            ...
            className={`relative z-10 w-9 sm:w-10 rounded-lg transition-all flex items-center justify-center group h-full ${
              sortBy === "rating"
                ? "text-primary"
