...
export const providers: Provider[] = [
  {
    ...
    technicalSpecs: {
      ...
      companyDescription:
        "Timeweb Cloud — один из крупнейших российских облачных провайдеров, специализирующийся на предоставлении VPS/VDS, выделенных серверов, облачных решений и хостинга. Компания известна высоким качеством обслуживания, современной инфраструктурой и быстрой технической поддержкой.",
      foundedYear: 2006,
      employeesCount: "500+",
